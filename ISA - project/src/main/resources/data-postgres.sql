insert  into  address (country,city,street,street_number,lon,lat) values ('Srbija','Novi Sad','Balzakova','58','19.833176','45.236439');
insert  into  address (country,city,street,street_number,lon,lat) values ('Srbija','Beograd','Alekse Santica','12','20.557021','44.757888');
...
insert  into  address (country,city,street,street_number,lon,lat) values ('Srbija','Novi Sad','Sekspirova','23','19.837780','45.240439');
insert  into  address (country,city,street,street_number,lon,lat) values ('Srbija','Novi Sad','Moca Santica','12','43.27,','44.23');
insert  into  address (country,city,street,street_number,lon,lat) values ('Srbija','Novi Sad','Dunavksa','6','19.848568','45.256737');
insert  into  address (country,city,street,street_number,lon,lat) values ('Srbija','Novi Sad','Gogoljeva','22','19.834566','45.246255');
...
insert  into  address (country,city,street,street_number,lon,lat) values ('Srbija','Novi Sad','Cara Dusana','19','19.825121','45.245596');
...
insert into blood_transfusion_center(name,address_id,average_grade,description,work_hours_id) values('Red Cross',5,4.0,'Bestest',2);
insert into blood_transfusion_center(name,address_id,average_grade,description,work_hours_id) values('Ambulance',7,2.0,'We are the nations most important blood detributor',3);
insert into blood_transfusion_center(name,address_id,average_grade,description,work_hours_id) values('Main Hospital',8,5.0,'We take good care of your blood',4);
insert into blood_transfusion_center(name,address_id,average_grade,description,work_hours_id) values('Center 14-1',13,5.0,'Your blood is safe with us',5);
...
VALUES (nextval('my_seq_gen_user'), 'client2@gmail.com', 'ime', 'male', true, '643', 'prez', '$2a$10$Se9RxWx8NYpBrCvzLjxyuul8D6oJhC6.W6srGYniLFqCiP/zOqupq', '234', 1, 3);
