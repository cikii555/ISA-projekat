...
@Component({
  selector: 'app-unauth-centers',
  templateUrl: './unauth-centers.component.html',
  styleUrls: ['./unauth-centers.component.css']
})
export class UnauthCentersComponent implements OnInit {
